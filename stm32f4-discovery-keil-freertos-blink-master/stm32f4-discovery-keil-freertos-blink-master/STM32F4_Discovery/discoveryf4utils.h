...
#define DEBUG_UART6                         USART6
#define DEBUG_UART6_PORT                    GPIOC
#define DEBUG_UART6_AF                      GPIO_AF_USART6
#define DEBUG_UART6_CLK                     RCC_APB2Periph_USART6
#define DEBUG_UART6_TX_PIN                  GPIO_Pin_6
#define DEBUG_UART6_TX_GPIO_PORT            GPIOC
#define DEBUG_UART6_TX_GPIO_CLK             RCC_AHB1Periph_GPIOC
#define DEBUG_UART6_TX_SOURCE               GPIO_PinSource6
#define DEBUG_UART6_TX_AF                   GPIO_AF_USART6
#define DEBUG_UART6_RX_PIN                  GPIO_Pin_7
#define DEBUG_UART6_RX_GPIO_PORT            GPIOC
#define DEBUG_UART6_RX_GPIO_CLK             RCC_AHB1Periph_GPIOC
#define DEBUG_UART6_RX_SOURCE               GPIO_PinSource7
#define DEBUG_UART6_RX_AF                   GPIO_AF_USART6
#define DEBUG_UART6_IRQn                    USART6_IRQn
