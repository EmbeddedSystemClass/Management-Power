...
#define LCD_RS_GPIO_PIN               	GPIO_Pin_1
 ...
 #define LCD_RW_GPIO_CLK               	RCC_APB2Periph_GPIOE // CONNET PIN RW TO GND
 #define LCD_RW_GPIO_PIN               	GPIO_Pin_7

#define LCD_EN_GPIO_PORT            	GPIOE
#define LCD_EN_GPIO_CLK               	RCC_AHB1Periph_GPIOE
#define LCD_EN_GPIO_PIN               	GPIO_Pin_8
//XXXXXXXXXXXXXXXXXXXXXXXX DATA D4..7
#define LCD_D4_GPIO_PORT            	GPIOE
#define LCD_D4_GPIO_CLK               	RCC_AHB1Periph_GPIOE
#define LCD_D4_GPIO_PIN               	GPIO_Pin_9

#define LCD_D5_GPIO_PORT            	GPIOE
#define LCD_D5_GPIO_CLK               	RCC_AHB1Periph_GPIOE
#define LCD_D5_GPIO_PIN               	GPIO_Pin_10

#define LCD_D6_GPIO_PORT            	GPIOE
#define LCD_D6_GPIO_CLK               	RCC_AHB1Periph_GPIOE
#define LCD_D6_GPIO_PIN               	GPIO_Pin_11

#define LCD_D7_GPIO_PORT            	GPIOE
#define LCD_D7_GPIO_CLK               	RCC_AHB1Periph_GPIOE
#define LCD_D7_GPIO_PIN               	GPIO_Pin_12
